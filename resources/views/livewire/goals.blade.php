        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    ...
                    @php
                        $systemGoals = $goals->whereNull('user_id');
                        $myGoals = $goals->where('user_id', Auth::id());
                        $hasMyGoals = $myGoals->isNotEmpty();
                        $hasSystemGoals = $systemGoals->isNotEmpty();
                        // Active tab: 'my' if user has goals, otherwise 'system'
                        $defaultTab = $hasMyGoals ? 'my' : 'system';
                    @endphp

                    @if ($hasMyGoals || $hasSystemGoals)
                                                    ...
                                                    <div class="flex justify-between items-start">
                                                        <div class="flex-1">
                                                            ...
                                                            <div
                                                                ...
                                                                <span>Created:
                                                                    {{ $goal->created_at->format('M j, Y') }}</span>
                                                            </div>
                                                            <div
                                            ...
                                            <div class="p-4 border border-gray-200 dark:border-gray-600 rounded-lg">
                                                <div class="flex-1">
                                                    ...
                                                    <p class="text-xs text-gray-500 dark:text-gray-400 mt-2">
                                                        Activities:
                                                        {{ $goal->activities_count ?? $goal->activities()->count() }}
                                                    </p>
                                                </div>
                                            </div>
                                        @endforeach
